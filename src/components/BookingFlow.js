...
export default function BookingFlow({ initialData = {}, onClose }) {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            // Prefer URL returned by backend (session URL)
            const checkoutUrl =
    ...
    return (
        <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-white/10 rounded-2xl w-full shadow-2xl overflow-hidden">
            {/* Header */}
            <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-b border-white/10 p-6 flex justify-between items-center">
                <div>
            ...
            {/* Footer */}
            <div className="bg-slate-900/50 border-t border-white/10 p-6 flex gap-4">
                {step > 1 && step < 4 && (
                    <button
                        type="button"

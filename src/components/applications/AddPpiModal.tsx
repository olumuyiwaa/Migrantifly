...
export function AddPpiModal({
    ...
    // Set default due date to 21 days from now
                ...
                <div className="mb-5 flex items-start justify-between">
                    <div>
                        <h2 className="text-lg font-semibold text-gray-800 dark:text-white/90">
                            Add Potentially Prejudicial Information (PPI)
                        </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Describe the potentially prejudicial information..."
                            rows={4}
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-theme-xs text-gray-500 dark:text-gray-400">
                            Typically 21 days from the date of request
                        </p>
                    </div>
